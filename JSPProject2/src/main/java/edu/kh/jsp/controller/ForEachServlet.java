...
public class ForEachServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		pList.add(new Person("홍길동", 15, "서울시 중구"));
		pList.add(new Person("김길동", 20, "서울시 종로구"));
		pList.add(new Person("고길동", 35, "서울시 서대문구"));
		pList.add(new Person("강길동", 41, "서울시 성동구"));
		pList.add(new Person("박길동", 28, "서울시 동대문구"));
