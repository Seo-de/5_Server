...
@WebServlet("/login") // web.xml에 작성하던 <servelt>, <servlet-mapping> 태그 대체 어노테이션
public class LoginServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(id.equals("user01") && pw.equals("pass01!")) { // 아이디가 user01, 비밀번호가 pqss01!인 경우
			result = "로그인 성공";
		}else {
...
//			out.printf("<h3 style='color:skyblue;'> %s </h3>", result);
...
//		out.println("</html>");
		...
		// req : 요청 관련 정보 데이터 / resp : 응답하는 방법(기능)
