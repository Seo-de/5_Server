...
// javax.servlet.http.HttpServlet 추상 클래스(직접 객체 생성 불가)를 반드시 상속 받아야 한다!
// - 요청, 응답을 위한 방법(메서드) 제공
// - tomcat에서 제공하는 클래스


// 추상 클래스 : 추상 메서드를 0개 이상 포함한 클래스
// 추상 메서드 : 이름만 있는 메서드. 상속받은 자식이 무조건 오버라이딩 해야함.
...
//		resp.setCharacterEncoding("UTF-8"); // 사용하면 안돼 글씨가 또 깨져
		...
		out.append(inputName + "님의 나이는 " + inputAge + "세 입니다.");
	} 
}
